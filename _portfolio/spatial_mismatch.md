...
<img
  src="{{ '/images/projects/spatial-mismatch/why-do-people-move-to-jabodetabek.png' | relative_url }}"
  alt="Why people move to Jabodetabek"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/where-do-people-commute.png' | relative_url }}"
  alt="Where people commute to"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/how-far-do-people-commute.png' | relative_url }}"
  alt="How far people commute"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/what-transport-modes-do-people-use.png' | relative_url }}"
  alt="What transport modes people use"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>

<img
  src="{{ '/images/projects/spatial-mismatch/how-many-transport-modes-do-people-use.png' | relative_url }}"
  alt="How many transport modes people use"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/when-do-people-start-commuting.png' | relative_url }}"
  alt="When people start commuting"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/when-do-people-arrive-home.png' | relative_url }}"
  alt="When people arrive home"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
<img
  src="{{ '/images/projects/spatial-mismatch/do-commuters-feel-stressed.png' | relative_url }}"
  alt="Do commuters feel stressed"
  style="width: 100%; max-width: 700px; height: auto; display: block; margin: 1em 0;"
/>
...
- **Commuter data**: Badan Pusat Statistik (Central Statistics Agency). [Statistik Komuter Jabodetabek: Hasil Survei Komuter Jabodetabek 2014](https://www.bps.go.id/en/publication/2014/03/17/c0deaf751b807b56681a9860/statistik-komuter-jabodetabek--hasil-survei-komuter-jabodetabek-2014-.html)
- **Population per district**: Kaggle. [Dataset Kepadatan Penduduk Jakarta](https://www.kaggle.com/datasets/elsaesitiya/dataset-kepadatan-penduduk-jakarta)
- **Business locations**: OpenStreetMap
